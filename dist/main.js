...
;// CONCATENATED MODULE: ./src/listarUsuarios.js
var listarUsuarios = function listarUsuarios(json) {
  json.forEach(function (usuario) {
    return inserirUsuarioNovo(usuario);
  });
};
function inserirUsuarioNovo(usuario) {
  ...
  item.innerHTML = "\n    <div>\n      <img src=\"".concat(usuario.foto, "\" />\n    </div>\n    <div>\n      <p>Nome: ").concat(usuario.nome, "</p>\n      <p>Sobrenome: ").concat(usuario.sobrenome, "</p>\n      <p>Idade: ").concat(usuario.idade, "</p>\n      <p>Monitor: ").concat(usuario.ehMonitor ? 'Sim' : 'Não', "</p>\n    </div>\n  ");
...
lib_axios.get('https://64e0d28850713530432cb8a3.mockapi.io/usuarios').then(function (response) {
